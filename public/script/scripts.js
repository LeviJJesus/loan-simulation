document.addEventListener('DOMContentLoaded', function () {
    ...
    function saveFormData(event) {
        ...
        const formData = {
            ...
            offerSmsWhatsappEmail: document.querySelector('input[name="offer-sms-whatsapp-email"]').checked,
            offerDaycoval: document.querySelector('input[name="offer-daycoval"]').checked,
            offerPartners: document.querySelector('input[name="offer-partners"]').checked
        };
